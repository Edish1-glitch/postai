...
סיים עם שאלה קצרה שמעוררת מעורבות ("מה דעתכם?" / "גם אתם חשתם כך?").`
    : `פורמט: HOOK ארוך — 6 פסקאות ברצף, ללא כותרות:
פסקה 1: שורה אחת שעוצרת גלילה — נתון/שאלה מפתיעה.
פסקה 2: 2 משפטים על הבעיה + נתון ספציפי ממחקר/חברה.
פסקה 3: תובנה ראשונה + דוגמה מהשוק, 2 משפטים.
פסקה 4: זווית שנייה + נתון נוסף, 2 משפטים.
פסקה 5: פעולה מעשית אחת — משפט אחד.
פסקה 6: שאלה לדיון + 2-3 hashtags.
כתוב את כל 6 הפסקאות ברצף. אל תוסיף כותרות, תוויות, או סימני פיסוק מיוחדים לפני כל פסקה.`,
...
חובה לסיים עם לקח מעשי + שאלה קצרה לקהל ("מה אתכם?").`
    : `פורמט: STORY ארוך — 6 פסקאות ברצף, בגוף ראשון, ללא כותרות:
פסקה 1: רקע — איפה הייתי, מספרים ספציפיים. 2 משפטים.
פסקה 2: הבעיה — מה לא עבד. 2 משפטים.
פסקה 3: הרגע המכריע — תאריך/סכום/החלטה. 2 משפטים.
פסקה 4: מה השתנה — לפני vs אחרי. 2 משפטים.
פסקה 5: הלקח — דבר אחד ליישום. משפט אחד.
פסקה 6: שאלה לקהל + 2-3 hashtags.
כתוב את כל 6 הפסקאות ברצף. אל תוסיף כותרות, תוויות, או סימני פיסוק מיוחדים לפני כל פסקה.
CRITICAL: חייב לסיים ב-"?".`,
