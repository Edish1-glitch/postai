...
⚠️ ${minTarget}+ תווים לפני hashtags. הפוסט לא גמור בלי שאלה + hashtags.`,
...
⚠️ ספור לפני סיום — חייב ${minTarget}+ תווים.`,
    ...
    datadrop: length !== 'long'
      ...
      : `פורמט: DATA DROP ארוך — כתוב 4 חלקים בסדר הזה:
1. סטטיסטיקה/עובדה מפתיעה + מקור.
2. מה זה אומר? הסבר + הרחבה.
3. דוגמה ספציפית + נתון שני מתקשר.
4. שאלה לדיון ("מה דעתכם?" / "גם אתם...?") + 2-3 hashtags.
⚠️ חובה לכלול את כל 4 החלקים. הפוסט לא גמור בלי שאלה + hashtags.`,
