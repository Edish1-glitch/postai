...
חוקי ברזל:
✅ אורך מחייב: בין ${minTarget} ל-${charTarget} תווים — לא פחות, לא יותר. ספור לפני שאתה מסיים${length === 'long' ? '\n✅ סיום חובה לפוסט ארוך: שאלה לדיון ("מה דעתכם?", "האם גם אתם...") או הנעה לפעולה ברורה' : ''}
