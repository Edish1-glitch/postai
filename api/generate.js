...
${length === 'long'
  ? 'המשך: פרט את התובנה בשלושה היבטים שונים, הוסף נתון/דוגמה לכל היבט, וסיים עם הנעה לפעולה.'
...
${length === 'long'
  ? 'פרט כל שלב לעומק: הקשר מלא → תיאור הרגע הספציפי עם נתונים → מה בדיוק השתנה → לקח מעשי שהקורא יכול ליישם היום. סיים עם שאלה לקהל.'
